...
class AmazonProduct:
    ...
    def __init__(self, URL, desired_rate):
        self.URL = URL
...
blanket = AmazonProduct('https://www.amazon.com/ADVANCED-Dual-Control-Electric-Certified-Radiation/dp/B07WC58PQD/ref=sr_1_4?keywords=heated+blanket+queen&qid=1575126371&sr=8-4', 85)
